...
//    V1.0      S.Petrovic     06 Dec 14     Initial version
//    V1.1      M.Stojanovic   17 Mar 16     Bug 3439 fixed -
//                                           four byte address commands
//                                           depend on CR2_V(0)
//    V1.2      M.Dinic        18 Jun 08     Bug 18 fixed -
...
module s25fl128l #(
    ...
    parameter mem_file_name     = "s25fl128l.mem",
    parameter secr_file_name    = "s25fl128lSECR.mem",
    parameter tdevice_PU      = 300000000,
    parameter tdevice_SUSP    = 40000000,
    parameter tdevice_DPD     = 3000000,
    parameter tdevice_RES     = 3000000,
    parameter tdevice_QEN     = 1500000,
    parameter tdevice_QEXN    = 1000000,
    parameter tdevice_RPH     = 100000000,
    parameter tdevice_BP1     = 25000000,
    parameter tdevice_BP2     = 20000000,
    parameter tdevice_PP      = 900000000,
    parameter tdevice_WRR     = 750000000,
    parameter tdevice_CS      = 50000,
    parameter tdevice_SE      = 200000000,
    parameter tdevice_HBE     = 363000000,
    parameter tdevice_BE      = 725000000,
    parameter tdevice_CE      = 180000000000,
    parameter tdevice_PASSACC = 100000000,
    parameter tdevice_RNS     = 100000000
)
    (
        // Data Inputs/Outputs
        SI     ,
...
///////////////////////////////////////////////////////////////////////////////
    ...
    parameter  PartID           = "s25fl128l";
    parameter  MaxData          = 255;
    parameter  MemSize          = 25'hFFFFFF;
    parameter  PageSize         = 8'hFF;
    parameter  SecRegSize       = 8'hFF;
    parameter  SecSize          = 13'hFFF;
    parameter  HalfBlockSize    = 16'h7FFF;
    parameter  BlockSize        = 17'hFFFF;
    parameter  SecNum           = 13'hFFF;
    parameter  BlockNum         = 9'hFF;
    parameter  HalfBlockNum     = 10'h1FF;
    parameter  SecRegNum        = 3;

    parameter  PageNum          = 20'hFFFF;
    ...
    parameter  ManufIDDeviceID  = 24'h186001;
    parameter  DeviceID         = 16'h6018;
    parameter  UID              = 64'b0;
...
//        `define SPEEDSIM;
    ...
    parameter RDID            = 5'd23;
    parameter RDQID           = 5'd24;
    parameter RUID            = 5'd25;
...
specify
    ...
    specparam        tperiod_SCK_fast     = 1;   //133 MHz
    specparam        tperiod_SCK_ddr      = 1;   // 80 MHz
    specparam        tperiod_SCK_reg      = 1;   // 108 MHz

    `ifdef SPEEDSIM
        // WRR Cycle Time
        // specparam tdevice_ // removed - using module parameters instead // was: WRR               = 750e6; //tW = 750us
        // Page Program Operation
        // specparam tdevice_ // removed - using module parameters instead // was: PP                = 900e6; //tPP = 900us
        // Byte Programming
        // specparam tdevice_ // removed - using module parameters instead // was: BP1               = 25e6; //tBP1 = 25us
        // Byte Programming
        // specparam tdevice_ // removed - using module parameters instead // was: BP2               = 20e6; //tBP2 = 20us
        // 4 KB Sector Erase Operation
        // specparam tdevice_ // removed - using module parameters instead // was: SE                = 200e6; //tSE = 200us
        // 32 KB Half Block Erase Operation
        // specparam tdevice_ // removed - using module parameters instead // was: HBE               = 363e6; //tHBE = 363us
       // 64 KB Block Erase Operation
        // specparam tdevice_ // removed - using module parameters instead // was: BE                = 725e6; //tBE = 725us
        // Chip Erase Operation
        // specparam tdevice_ // removed - using module parameters instead // was: CE                = 180e9; //tCE = 180ms
        // Suspend Latency
        // specparam tdevice_ // removed - using module parameters instead // was: SUSP              = 40e6; //tSL = 40us
        // Resume to next Suspend Time
        // specparam tdevice_ // removed - using module parameters instead // was: RNS               = 100e6;//tRS = 100 us
        // RESET# Low to CS# Low
        // specparam tdevice_ // removed - using module parameters instead // was: RPH               = 100e6; //tRPH = 100 us
        // VDD (min) to CS# Low
        // specparam tdevice_ // removed - using module parameters instead // was: PU                = 300e6;//tPU = 300us
        // Password Unlock to Password Unlock Time
        // specparam tdevice_ // removed - using module parameters instead // was: PASSACC           = 100e6;// 100us
        // DPD enter
        // specparam tdevice_ // removed - using module parameters instead // was: DPD               = 3e6;// 3us
        // Release DPD
        // specparam tdevice_ // removed - using module parameters instead // was: RES               = 3e6;// 3us
        // QIO, QPI mode enter to the next command
        // specparam tdevice_ // removed - using module parameters instead // was: QEN               = 1.5e6;// 1.5us
        // QIO, QPI mode exit to the next command
        // specparam tdevice_ // removed - using module parameters instead // was: QEXN              = 1e6;// 1us
        // Volatile registers write time
        // specparam tdevice_ // removed - using module parameters instead // was: CS               = 50e3; //tCS = 50ns
    `else
        // WRR Cycle Time
        // specparam tdevice_ // removed - using module parameters instead // was: WRR               = 750e9; //tW = 750ms
        // Page Program Operation
        // specparam tdevice_ // removed - using module parameters instead // was: PP                = 900e6; //tPP = 900us
        // Byte Programming
        // specparam tdevice_ // removed - using module parameters instead // was: BP1               = 25e6; //tBP1 = 25us
        ...
        // specparam tdevice_ // removed - using module parameters instead // was: BP2               = 20e6; //tBP2 = 20us
        // 4 KB Sector Erase Operation
        // specparam tdevice_ // removed - using module parameters instead // was: SE                = 200e9; //tSE = 200ms
        // 32 KB Half Block Erase Operation
        // specparam tdevice_ // removed - using module parameters instead // was: HBE               = 363e9; //tHBE = 363ms
       // 64 KB Block Erase Operation
        // specparam tdevice_ // removed - using module parameters instead // was: BE                = 725e9; //tBE = 725ms
        // Chip Erase Operation
        // specparam tdevice_ // removed - using module parameters instead // was: CE                = 180e12; //tCE = 180s
        // Suspend Latency
        // specparam tdevice_ // removed - using module parameters instead // was: SUSP              = 40e6; //tSL = 40us
        // Resume to next Suspend Time
        // specparam tdevice_ // removed - using module parameters instead // was: RNS               = 100e6;//tRS = 100 us
...
///////////////////////////////////////////////////////////////////////////////
    ...
    integer i;
        ...
        SFDP_array[16'h0324] = 8'h21;
        SFDP_array[16'h0325] = 8'h5A;
        SFDP_array[16'h0326] = 8'hC1;
        SFDP_array[16'h0327] = 8'hFE;
        SFDP_array[16'h0328] = 8'h81;
        SFDP_array[16'h0329] = 8'hE4;
        SFDP_array[16'h032A] = 8'h29;
        SFDP_array[16'h032B] = 8'hD1;
    ...
    begin
        ...
        begin
            if (RESETNeg)
            begin
                // disable HW_RESET // Verilator unsupported;
                RST = 1'b1;
            end
        end
    end
...
///////////////////////////////////////////////////////////////////////////////
    ...
    begin : ProgTime
        ...
        begin
            ...
            // disable pdone_process // Verilator unsupported;
        end
        else if (reseted)
        begin
...
///////////////////////////////////////////////////////////////////////////////
    ...
    begin:WriteTime
        ...
        begin
            ...
            // disable wdone_process // Verilator unsupported;
        end
        else if (reseted)
        begin
...
///////////////////////////////////////////////////////////////////////////////
    ...
    begin : ErsTime
        ...
        begin
            ...
            // disable edone_process // Verilator unsupported;
        end
        else if (reseted)
        begin
            ...
            begin
                ...
                begin
                    ...
                    if (dummy_cnt == Latency_code)
                        ...
                        (CLK_PER < 9250  && Latency_code == 8) || // > 108MHz
                        (CLK_PER < 8965 && Latency_code <= 10) || // > 115MHz
                        (CLK_PER < 8333 && Latency_code <= 12))  // > 120MHz
                        begin
                            $display ("More wait states are required for");
                            $display ("this clock frequency value");
                        end
            ...
            begin
                ...
                begin
                    ...
                    if (dummy_cnt == Latency_code)
                        ...
                        (CLK_PER < 10520 && Latency_code == 7) || // > 95MHz
                        (CLK_PER < 9250  && Latency_code == 8) || // > 108MHz
                        (CLK_PER < 8695 && Latency_code <= 10) || // > 115MHz
                        (CLK_PER < 8333 && Latency_code <= 12))  // > 120MHz
                        begin
                            $display ("More wait states are required for");
                            $display ("this clock frequency value");
            ...
            begin
                ...
                begin
                    ...
                    if (dummy_cnt == 2*Latency_code)
                        ...
                        (CLK_PER < 16660 && Latency_code <= 6))   // > 60MHz
                        begin
                            $display ("More wait states are required for");
                            $display ("this clock frequency value");
                        end
                ...
                begin
                    ...
                    begin
                        ...
                        begin
                            ...
                            (CLK_PER < 8695 && Latency_code <= 12) || // > 115MHz
                            (CLK_PER < 8330 && Latency_code <= 14))  // > 120MHz
                            begin
                                $display ("More wait states are required for");
                                $display ("this clock frequency value");
                            end
        ...
        begin
            ...
            begin
                ...
                begin
                    if (!SEC)
                        ...
                        Legacy_Sec_Prot[SecNum : (SecNum-1)] = 2'b1;
                end
                else
                begin
                    if (!SEC)
            ...
            begin
                ...
                begin
                    if (!SEC)
                        ...
                        Legacy_Sec_Prot[SecNum : (SecNum-3)] = 4'b1;
                end
                else
                begin
                    if (!SEC)
            ...
            begin
                ...
                begin
                    if (!SEC)
                        ...
                        Legacy_Sec_Prot[SecNum : (SecNum-7)] = 8'b1;
                end
                else
                begin
                    if (!SEC)
           ...
           3'b110:
            begin
                ...
                begin
                    if (!SEC)
                        Legacy_Sec_Prot[SecNum : (SecNum-2047)] = {2048{1'b1}};
                    else
                        Legacy_Sec_Prot[SecNum : (SecNum-7)] = 8'b1;
                end
                else
                begin
                    if (!SEC)
                        Legacy_Sec_Prot[2047 : 0] = {2048{1'b1}};
                    else
                        Legacy_Sec_Prot[7:0] = 8'b1;
                end
            end
        ...
        begin
            ...
            begin
                ...
                begin
                    if (!SEC)
                        ...
                        Legacy_Sec_Prot[SecNum : (SecNum-1)] = 2'b0;
                end
                else
                begin
                    if (!SEC)
            ...
            begin
                ...
                begin
                    if (!SEC)
                        ...
                        Legacy_Sec_Prot[SecNum : (SecNum-3)] = 4'b0;
                end
                else
                begin
                    if (!SEC)
            ...
            begin
                ...
                begin
                    if (!SEC)
                        ...
                        Legacy_Sec_Prot[SecNum : (SecNum-7)] = 8'b0;
                end
                else
                begin
                    if (!SEC)
           ...
           3'b110:
            begin
                ...
                begin
                    if (!SEC)
                        Legacy_Sec_Prot[SecNum : (SecNum-2047)] = {2048{1'b0}};
                    else
                        Legacy_Sec_Prot[SecNum : (SecNum-7)] = 8'b0;
                end
                else
                begin
                    if (!SEC)
                        Legacy_Sec_Prot[2047 : 0] = {2048{1'b0}};
                    else
                        Legacy_Sec_Prot[7:0] = 8'b0;
                end
            end
