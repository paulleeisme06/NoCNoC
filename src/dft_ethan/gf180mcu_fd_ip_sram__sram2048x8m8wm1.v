...
module gf180mcu_fd_ip_sram__sram2048x8m8wm1 (
	CLK,
	CEN,
	GWEN,
	WEN,
...
//---- A[10:0] setup/hold timing
  ...
  $setup (posedge A[10], posedge CLK &&& cen_flag, tas, ntf_tas);
  ...
  $setup (negedge A[10], posedge CLK &&& cen_flag, tas, ntf_tas);
  ...
  $hold  (posedge CLK &&& cen_flag, negedge A[10], tah, ntf_tah);
  ...
  $hold  (posedge CLK &&& cen_flag, posedge A[10], tah, ntf_tah);
